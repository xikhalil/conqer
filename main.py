# main.py
# ==================================================
# 🚀 TRADING BOT MAIN MODULE – ENTRY POINT 🚀
# ==================================================
    ...
    while True:
        try:
            ...
            if market_data is None or market_data.empty:
                Utils.log_message("⚠️ No valid market data. Skipping cycle.", "warning")
            ...
            if order:
                profit_tracker.update_trade(
                    "WIN" if order["profit"] > 0 else "LOSS",
                    order["profit"]
                )
            ...
            Utils.log_message(f"❌ Trading Error: {e}", "error")
